...
import com.datamaster.module.assets.convert.assetchild.operate.AssetsAssetOperateApplyConvert;
...
/**
 * 数据资产操作申请Controller * * @author DATAMASTER * @date 2025-05-09
 */
@Tag(name = "数据资产操作申请")
@RestController
@RequestMapping("/ast/assetOperateApply")
@Validated
public class AssetsAssetOperateApplyController extends BaseController {
    @Resource
    ...
    public CommonResult<PageResult<AssetsAssetOperateApplyRespVO>> list(AssetsAssetOperateApplyPageReqVO AssetsAssetOperateApply) {
        ...
        return CommonResult.success(BeanUtils.toBean(page, AssetsAssetOperateApplyRespVO.class));
    }
    ...
    public void export(HttpServletResponse response, AssetsAssetOperateApplyPageReqVO exportReqVO) {
        ...
        List<AssetsAssetOperateApplyDO> list = (List<AssetsAssetOperateApplyDO>) AssetsAssetOperateApplyService.getAssetOperateApplyPage(exportReqVO).getRows();
        ExcelUtil<AssetsAssetOperateApplyRespVO> util = new ExcelUtil<>(AssetsAssetOperateApplyRespVO.class);
        util.exportExcel(response, AssetsAssetOperateApplyConvert.INSTANCE.convertToRespVOList(list), "应用管理数据");
    }
    ...
    public AjaxResult importData(MultipartFile file, boolean updateSupport) throws Exception {
        ExcelUtil<AssetsAssetOperateApplyRespVO> util = new ExcelUtil<>(AssetsAssetOperateApplyRespVO.class);
        List<AssetsAssetOperateApplyRespVO> importExcelList = util.importExcel(file.getInputStream());
        String operName = getUsername();
        String message = AssetsAssetOperateApplyService.importAssetOperateApply(importExcelList, updateSupport, operName);
    ...
    public CommonResult<AssetsAssetOperateApplyRespVO> getInfo(@PathVariable("id") Long id) {
        ...
        return CommonResult.success(BeanUtils.toBean(AssetsAssetOperateApplyDO, AssetsAssetOperateApplyRespVO.class));
    }
    ...
    public CommonResult<Long> add(@Valid @RequestBody AssetsAssetOperateApplySaveReqVO AssetsAssetOperateApply) {
        AssetsAssetOperateApply.setCreatorId(getUserId());
        AssetsAssetOperateApply.setCreateBy(getNickName());
        AssetsAssetOperateApply.setCreateTime(DateUtil.date());
        return CommonResult.toAjax(AssetsAssetOperateApplyService.createAssetOperateApply(AssetsAssetOperateApply));
    }
    ...
    public CommonResult<Integer> edit(@Valid @RequestBody AssetsAssetOperateApplySaveReqVO AssetsAssetOperateApply) {
        AssetsAssetOperateApply.setUpdatorId(getUserId());
        AssetsAssetOperateApply.setUpdateBy(getNickName());
        AssetsAssetOperateApply.setUpdateTime(DateUtil.date());
        return CommonResult.toAjax(AssetsAssetOperateApplyService.updateAssetOperateApply(AssetsAssetOperateApply));
    }
    ...
    public CommonResult<Integer> remove(@PathVariable Long[] ids) {
        return CommonResult.toAjax(AssetsAssetOperateApplyService.removeAssetOperateApply(Arrays.asList(ids)));
    }
}