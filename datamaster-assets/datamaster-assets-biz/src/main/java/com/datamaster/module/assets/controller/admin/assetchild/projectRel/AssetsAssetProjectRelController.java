package com.datamaster.module.assets.controller.admin.assetchild.projectRel;
...
import com.datamaster.module.assets.convert.assetchild.projectRel.AssetsAssetProjectRelConvert;
...
@Validated
public class AssetsAssetProjectRelController extends BaseController {
    @Resource
    ...
    public void export(HttpServletResponse response, AssetsAssetProjectRelPageReqVO exportReqVO) {
        ...
        List<AssetsAssetProjectRelDO> list = (List<AssetsAssetProjectRelDO>) AssetsAssetProjectRelService.getAssetProjectRelPage(exportReqVO).getRows();
    ...
    public AjaxResult importData(MultipartFile file, boolean updateSupport) throws Exception {
        ExcelUtil<AssetsAssetProjectRelRespVO> util = new ExcelUtil<>(AssetsAssetProjectRelRespVO.class);
        List<AssetsAssetProjectRelRespVO> importExcelList = util.importExcel(file.getInputStream());
        String operName = getUsername();
        String message = AssetsAssetProjectRelService.importAssetProjectRel(importExcelList, updateSupport, operName);
    ...
    public CommonResult<Long> add(@Valid @RequestBody AssetsAssetProjectRelSaveReqVO AssetsAssetProjectRel) {
        ...
        AssetsAssetProjectRel.setCreateBy(getNickName());
        AssetsAssetProjectRel.setCreateTime(DateUtil.date());
    ...
    public CommonResult<Integer> edit(@Valid @RequestBody AssetsAssetProjectRelSaveReqVO AssetsAssetProjectRel) {
        ...
        AssetsAssetProjectRel.setUpdateBy(getNickName());
        AssetsAssetProjectRel.setUpdateTime(DateUtil.date());
