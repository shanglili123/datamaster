...
import java.util.Date;/** *  Response VO  DA_ASSET_PROJECT_REL * * @author DATAMASTER * @date 2025-04-18 */
@Schema(description = " Response VO")
@Data
public class AssetsAssetProjectRelRespVO implements Serializable {
