package com.datamaster.module.assets.controller.admin.assetchild.theme;
...
import com.datamaster.module.assets.convert.assetchild.theme.AssetsAssetThemeRelConvert;
...
/**
 * 数据资产-主题关联关系Controller * * @author DATAMASTER * @date 2025-04-14
 */
@Tag(name = "数据资产-主题关联关系")
@RestController
@RequestMapping("/ast/assetThemeRel")
@Validated
public class AssetsAssetThemeRelController extends BaseController {
    @Resource
    ...
    public CommonResult<PageResult<AssetsAssetThemeRelRespVO>> list(AssetsAssetThemeRelPageReqVO AssetsAssetThemeRel) {
        ...
        return CommonResult.success(BeanUtils.toBean(page, AssetsAssetThemeRelRespVO.class));
    }
    ...
    public void export(HttpServletResponse response, AssetsAssetThemeRelPageReqVO exportReqVO) {
        ...
        List<AssetsAssetThemeRelDO> list = (List<AssetsAssetThemeRelDO>) AssetsAssetThemeRelService.getAssetThemeRelPage(exportReqVO).getRows();
        ExcelUtil<AssetsAssetThemeRelRespVO> util = new ExcelUtil<>(AssetsAssetThemeRelRespVO.class);
        util.exportExcel(response, AssetsAssetThemeRelConvert.INSTANCE.convertToRespVOList(list), "应用管理数据");
    }
    ...
    public AjaxResult importData(MultipartFile file, boolean updateSupport) throws Exception {
        ExcelUtil<AssetsAssetThemeRelRespVO> util = new ExcelUtil<>(AssetsAssetThemeRelRespVO.class);
        List<AssetsAssetThemeRelRespVO> importExcelList = util.importExcel(file.getInputStream());
        String operName = getUsername();
        String message = AssetsAssetThemeRelService.importAssetThemeRel(importExcelList, updateSupport, operName);
    ...
    public CommonResult<AssetsAssetThemeRelRespVO> getInfo(@PathVariable("id") Long id) {
        ...
        return CommonResult.success(BeanUtils.toBean(AssetsAssetThemeRelDO, AssetsAssetThemeRelRespVO.class));
    }
    ...
    public CommonResult<Long> add(@Valid @RequestBody AssetsAssetThemeRelSaveReqVO AssetsAssetThemeRel) {
        AssetsAssetThemeRel.setCreatorId(getUserId());
        AssetsAssetThemeRel.setCreateBy(getNickName());
        AssetsAssetThemeRel.setCreateTime(DateUtil.date());
        return CommonResult.toAjax(AssetsAssetThemeRelService.createAssetThemeRel(AssetsAssetThemeRel));
    }
    ...
    public CommonResult<Integer> edit(@Valid @RequestBody AssetsAssetThemeRelSaveReqVO AssetsAssetThemeRel) {
        AssetsAssetThemeRel.setUpdatorId(getUserId());
        AssetsAssetThemeRel.setUpdateBy(getNickName());
        AssetsAssetThemeRel.setUpdateTime(DateUtil.date());
        return CommonResult.toAjax(AssetsAssetThemeRelService.updateAssetThemeRel(AssetsAssetThemeRel));
    }
    ...
    public CommonResult<Integer> remove(@PathVariable Long[] ids) {
        return CommonResult.toAjax(AssetsAssetThemeRelService.removeAssetThemeRel(Arrays.asList(ids)));
    }
}