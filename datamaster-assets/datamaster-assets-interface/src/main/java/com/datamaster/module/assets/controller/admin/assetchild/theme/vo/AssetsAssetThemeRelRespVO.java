...
import java.util.Date;/** * - Response VO  DA_ASSET_THEME_REL * * @author DATAMASTER * @date 2025-04-14 */
@Schema(description = "- Response VO")
@Data
public class AssetsAssetThemeRelRespVO implements Serializable {
...
@Excel(name = "id")    @Schema(description = "id", example = "")    private Long themeId;
@TableField(exist = false)    private String themeName;
