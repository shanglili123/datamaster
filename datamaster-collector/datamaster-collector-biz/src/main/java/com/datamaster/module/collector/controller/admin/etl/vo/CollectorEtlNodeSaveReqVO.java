...
/**
 * 数据集成节点 创建/修改 Request VO COL_ETL_NODE
 *
 * @author DATAMASTER
 * @date 2025-02-13
 */
...
@Data
public class CollectorEtlNodeSaveReqVO extends BaseEntity {
    ...
    public boolean equals(Object o) {
        ...
        if(o instanceof CollectorEtlNodeLogDO){
            CollectorEtlNodeLogDO that = (CollectorEtlNodeLogDO) o;
            ...
            CollectorEtlNodeSaveReqVO that = (CollectorEtlNodeSaveReqVO) o;
            return Objects.equals(name, that.getName())
                    && Objects.equals(taskType, that.getTaskType())
                    && Objects.equals(type, that.getType())
                    && Objects.equals(priority, that.getPriority())
