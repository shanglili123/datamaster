...
/**
 * 数据集成任务节点关系-日志 DO 对象 COL_ETL_TASK_NODE_REL_LOG
 *
 * @author DATAMASTER
 * @date 2025-02-13
 */
@Data
@TableName(value = "COL_ETL_TASK_NODE_REL_LOG")
// 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
// @KeySequence("COL_ETL_TASK_NODE_REL_LOG_seq")
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class CollectorEtlTaskNodeRelLogDO extends BaseEntity {
...
/**
    ...
    public boolean equals(Object o) {
        ...
        CollectorEtlTaskNodeRelLogDO that = (CollectorEtlTaskNodeRelLogDO) o;
