...
public class RelationalIncrementalBoundaryQuery implements IncrementalBoundaryQuery {
    ...
    @Override
    public Object queryMaxValue(DatasourceRespDTO datasource, String tableName, String columnName) {
    ...
    private void validateDatasource(DatasourceRespDTO datasource) {
        if (datasource == null) {
