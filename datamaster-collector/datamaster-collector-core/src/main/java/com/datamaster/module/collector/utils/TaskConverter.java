...
public class TaskConverter {
    ...
    private static IDatasourceApiService ASSETS_DATASOURCE_API;
...
//        Map<String, Object> definitionJsonMap = JSONUtils.convertTaskDefinitionJsonMap(draftJson);
    ...
    private static void resolveDsDatasourceId(String componentType, Map<String, Object> params) {
        ...
        try {
            ...
            DatasourceRespDTO dto = ASSETS_DATASOURCE_API.getDatasourceById(id);
            if (dto == null) {
    ...
    private static Map<String, Object> buildIncrementalHttpTask(Long id, String name, String code,
        ...
        Map<String, Object> processInstanceIdParam = new HashMap<>();
        processInstanceIdParam.put("prop", "processInstanceId");
        processInstanceIdParam.put("httpParametersType", "PARAMETER");
        processInstanceIdParam.put("value", "${system.workflow.instance.id}");
        httpParams.add(processInstanceIdParam);
