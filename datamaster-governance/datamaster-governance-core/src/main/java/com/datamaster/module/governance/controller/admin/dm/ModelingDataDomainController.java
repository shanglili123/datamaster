...
package com.datamaster.module.governance.controller.admin.dm;
...
import com.datamaster.module.governance.controller.admin.dm.vo.ModelingDataDomainPageReqVO;
import com.datamaster.module.governance.controller.admin.dm.vo.ModelingDataDomainRespVO;
import com.datamaster.module.governance.controller.admin.dm.vo.ModelingDataDomainSaveReqVO;
import com.datamaster.module.governance.convert.dm.ModelingDataDomainConvert;
import com.datamaster.module.governance.dal.dataobject.dm.ModelingDataDomainDO;
import com.datamaster.module.governance.service.dm.IModelingDataDomainService;
...
public class ModelingDataDomainController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('mdl:dataDomain:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('mdl:dataDomain:export')")
    ...
    @PreAuthorize("@ss.hasPermi('mdl:dataDomain:import')")
    ...
    @PreAuthorize("@ss.hasPermi('mdl:dataDomain:query')")
    @GetMapping(value = "/{id}")
    ...
    @PreAuthorize("@ss.hasPermi('mdl:dataDomain:add')")
    ...
    @PreAuthorize("@ss.hasPermi('mdl:dataDomain:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('mdl:dataDomain:remove')")
