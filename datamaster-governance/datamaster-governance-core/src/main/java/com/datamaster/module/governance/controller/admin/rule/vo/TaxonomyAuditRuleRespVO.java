...
package com.datamaster.module.governance.controller.admin.rule.vo;
...
/**
 * 稽查规则 Response VO 对象 TAX_AUDIT_RULE
 *
 * @author DATAMASTER
 * @date 2025-01-20
 */
...
@Data
public class TaxonomyAuditRuleRespVO implements Serializable {
     ...
     * 子节点列表
     */
    private List<TaxonomyAuditRuleRespVO> children;
