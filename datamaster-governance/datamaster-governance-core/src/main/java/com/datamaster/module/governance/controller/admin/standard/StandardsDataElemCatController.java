package com.datamaster.module.governance.controller.admin.standard;
...
import com.datamaster.module.governance.controller.admin.standard.vo.StandardsDataElemCatRespVO;
...
@Tag(name = "数据元类目管理")
@RestController
@RequestMapping("/cat/dataElemCat")
@Validated
