package com.datamaster.module.governance.service.dataElem.impl;
...
import com.datamaster.module.governance.api.service.dataElem.IDataElemApiService;
import com.datamaster.module.governance.controller.admin.dataElem.vo.StandardsDataElemPageReqVO;
import com.datamaster.module.governance.controller.admin.dataElem.vo.StandardsDataElemRespVO;
import com.datamaster.module.governance.controller.admin.dataElem.vo.StandardsDataElemSaveReqVO;
...
import com.datamaster.module.governance.dal.mapper.dataElem.StandardsDataElemMapper;
...
public class StandardsDataElemServiceImpl extends ServiceImpl<StandardsDataElemMapper, StandardsDataElemDO> implements IStandardsDataElemService, IDataElemApiService {
    ...
    public StandardsDataElemDO getDpDataElemById(Long id) {
        ...
        lambdaWrapper.selectAll(StandardsDataElemDO.class)
                ...
                .leftJoin("TAX_CATEGORY t2 on t.CAT_CODE = t2.CODE AND t2.DEL_FLAG = '0' AND t2.CAT_TYPE = 'DATA_ELEM'")
