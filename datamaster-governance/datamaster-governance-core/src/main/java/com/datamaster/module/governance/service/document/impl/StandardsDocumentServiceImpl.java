package com.datamaster.module.governance.service.document.impl;
...
import com.datamaster.module.governance.api.service.document.IStandardsDocumentApiService;
import com.datamaster.module.governance.controller.admin.document.vo.*;
import com.datamaster.module.governance.dal.dataobject.document.StandardsDocumentDO;
import com.datamaster.module.governance.dal.mapper.document.StandardsDocumentMapper;
...
public class StandardsDocumentServiceImpl  extends ServiceImpl<StandardsDocumentMapper,StandardsDocumentDO> implements IStandardsDocumentService, IStandardsDocumentApiService {
    ...
    public List<StandardsDocumentDO> getDpDocumentList(StandardsDocumentPageReqVO reqVO) {
        ...
        lambdaWrapper.selectAll(StandardsDocumentDO.class)
                ...
                .leftJoin("TAX_CATEGORY t2 on t.CAT_CODE = t2.CODE AND t2.DEL_FLAG = '0' AND t2.CAT_TYPE = 'DOCUMENT'")
