...
package com.datamaster.module.governance.service.rule.impl;
...
import com.datamaster.module.governance.controller.admin.rule.vo.TaxonomyCleanRulePageReqVO;
import com.datamaster.module.governance.controller.admin.rule.vo.TaxonomyCleanRuleRespVO;
import com.datamaster.module.governance.controller.admin.rule.vo.TaxonomyCleanRuleSaveReqVO;
import com.datamaster.module.governance.dal.dataobject.rule.TaxonomyCleanRuleDO;
import com.datamaster.module.governance.dal.dataobject.rule.enums.CleanRuleTypeEnum;
import com.datamaster.module.governance.dal.mapper.rule.TaxonomyCleanRuleMapper;
import com.datamaster.module.governance.service.rule.ITaxonomyCleanRuleService;
...
public class TaxonomyCleanRuleServiceImpl extends ServiceImpl<TaxonomyCleanRuleMapper, TaxonomyCleanRuleDO>
    ...
    public List<TaxonomyCleanRuleRespVO> getAttCleanRuleList(TaxonomyCleanRulePageReqVO TaxonomyCleanRule) {
        ...
        lambdaWrapper.selectAll(TaxonomyCleanRuleDO.class)
                ...
                .leftJoin("TAX_CATEGORY t2 on t.CAT_CODE = t2.CODE AND t2.DEL_FLAG = '0' AND t2.CAT_TYPE = 'CLEAN'")
