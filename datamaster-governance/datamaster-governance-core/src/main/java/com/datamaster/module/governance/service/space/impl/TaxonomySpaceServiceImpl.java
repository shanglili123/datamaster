...
package com.datamaster.module.governance.service.space.impl;
...
import com.datamaster.module.governance.dal.mapper.space.TaxonomySpaceMapper;
import com.datamaster.module.governance.dal.mapper.space.TaxonomySpaceUserRelMapper;
...
public class TaxonomySpaceServiceImpl extends ServiceImpl<TaxonomySpaceMapper, TaxonomySpaceDO> implements ITaxonomySpaceService, ISpaceApi {
    @Resource
    ...
    @Override
    public PageResult<SpaceRespDTO> getSpacePage(SpaceReqDTO pageReqVO) {
        ...
        return BeanUtils.toBean(TaxonomySpacePage, SpaceRespDTO.class);
    }
