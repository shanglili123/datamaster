...
package com.datamaster.module.governance.api.model.dto;

import lombok.Data;
import com.datamaster.common.database.core.DbColumn;

/**
 * 逻辑模型属性信息 DTO 对象 STD_MODEL_COLUMN
 *
 * @author DATAMASTER
 * @date 2025-01-21
 */
@Data
public class StandardsModelColumnReqDTO {
    ...
    // 构造方法
    public StandardsModelColumnReqDTO(DbColumn column) {
        if (column != null) {
