package com.datamaster.metadata.controller.admin.tableLog;
...
import com.datamaster.metadata.controller.admin.tableLog.vo.CatalogTableLogPageReqVO;
import com.datamaster.metadata.controller.admin.tableLog.vo.CatalogTableLogRespVO;
import com.datamaster.metadata.controller.admin.tableLog.vo.CatalogTableLogSaveReqVO;
import com.datamaster.metadata.convert.tableLog.CatalogTableLogConvert;
import com.datamaster.metadata.dal.dataobject.tableLog.CatalogTableLogDO;
...
@Tag(name = "元数据信息 - 日志")
@RestController
@RequestMapping("/cat/catalogTableLog")
@Validated
