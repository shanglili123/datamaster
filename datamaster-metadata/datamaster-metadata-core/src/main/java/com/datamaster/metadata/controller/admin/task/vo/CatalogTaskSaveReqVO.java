...
public class CatalogTaskSaveReqVO extends BaseEntity {
    ...
    /** 质量探查稽查对象列表 */
    @Schema(description = "质量探查稽查对象列表")
    @TableField(exist = false)
    private List<QualityTaskObjSaveReqVO> qualityObjs;

    /** 质量探查评测规则列表 */
    @Schema(description = "质量探查评测规则列表")
    @TableField(exist = false)
    private List<QualityTaskEvaluateSaveReqVO> qualityEvaluates;
