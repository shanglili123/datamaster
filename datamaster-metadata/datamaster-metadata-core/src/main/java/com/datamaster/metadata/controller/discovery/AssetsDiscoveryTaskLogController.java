package com.datamaster.metadata.controller.discovery;import cn.hutool.core.date.DateUtil;import io.swagger.v3.oas.annotations.Operation;import io.swagger.v3.oas.annotations.tags.Tag;import org.springframework.security.access.prepost.PreAuthorize;import org.springframework.validation.annotation.Validated;import org.springframework.web.bind.annotation.*;import org.springframework.web.multipart.MultipartFile;import com.datamaster.common.annotation.Log;import com.datamaster.common.core.controller.BaseController;import com.datamaster.common.core.domain.AjaxResult;import com.datamaster.common.core.domain.CommonResult;import com.datamaster.common.core.domain.ReturnT;import com.datamaster.common.core.page.PageParam;import com.datamaster.common.core.page.PageResult;import com.datamaster.common.enums.BusinessType;import com.datamaster.common.utils.object.BeanUtils;import com.datamaster.common.utils.poi.ExcelUtil;import com.datamaster.metadata.controller.discovery.vo.AssetsDiscoveryTaskLogPageReqVO;import com.datamaster.metadata.controller.discovery.vo.AssetsDiscoveryTaskLogRespVO;import com.datamaster.metadata.controller.discovery.vo.AssetsDiscoveryTaskLogSaveReqVO;import com.datamaster.metadata.controller.discovery.vo.LogResult;import com.datamaster.metadata.convert.discovery.AssetsDiscoveryTaskLogConvert;import com.datamaster.metadata.dal.dataobject.discovery.AssetsDiscoveryTaskLogDO;import com.datamaster.metadata.service.discovery.IAssetsDiscoveryTaskLogService;import javax.annotation.Resource;import javax.servlet.http.HttpServletResponse;import javax.validation.Valid;import java.io.*;import java.util.Arrays;import java.util.List;/** * 数据发现任务日志Controller * * @author DATAMASTER * @date 2025-02-17 */
