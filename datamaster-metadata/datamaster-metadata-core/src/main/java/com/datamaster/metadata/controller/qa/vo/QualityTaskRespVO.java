...
@AllArgsConstructor
@NoArgsConstructor
public class QualityTaskRespVO implements Serializable {
    ...
    // 质量探查任务-稽查对象
    private List<QualityTaskObjRespVO> QualityTaskObjSaveReqVO;

    // 规则对象
    private List<QualityTaskEvaluateRespVO> QualityTaskEvaluateRespVOS;
    @Excel(name = "稽查对象数")
    ...
    @Schema(description = "质量探查日志ID", example = "")
    private Long logId;
    ...
    @Schema(description = "流程定义ID", example = "")
    private Long taskId;
