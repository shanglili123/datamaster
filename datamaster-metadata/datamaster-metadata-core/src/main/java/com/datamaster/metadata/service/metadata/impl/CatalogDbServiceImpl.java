...
import com.datamaster.metadata.controller.admin.metadata.vo.CatalogDbPageReqVO;
import com.datamaster.metadata.controller.admin.metadata.vo.CatalogDbRespVO;
import com.datamaster.metadata.controller.admin.metadata.vo.CatalogDbSaveReqVO;
import com.datamaster.metadata.controller.admin.metadata.vo.CatalogMetaSearchRespDTO;
    ...
    public CatalogDbRespVO getCatalogDbById(Long id) {
       // return CatalogDbMapper.selectById(id);
        ...
        if (respVO.getDatasourceId() != null) {
            DatasourceRespDTO datasource = daDatasourceApiService.getDatasourceById(respVO.getDatasourceId());
