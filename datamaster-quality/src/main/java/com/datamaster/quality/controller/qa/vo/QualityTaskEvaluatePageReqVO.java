...
/**
 * 质量探查任务-评测规则 Request VO 对象 COL_QUALITY_TASK_EVALUATE
 *
 * @author Chaos
 * @date 2025-07-21
 */
@Schema(description = "质量探查任务-评测规则 Request VO")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class QualityTaskEvaluatePageReqVO extends PageParam {
