...
/**
 * 质量探查任务-评测规则 创建/修改 Request VO COL_QUALITY_TASK_EVALUATE
 *
 * @author Chaos
 * @date 2025-07-21
 */
@Schema(description = "质量探查任务-评测规则 Response VO")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class QualityTaskEvaluateSaveReqVO extends BaseEntity {
