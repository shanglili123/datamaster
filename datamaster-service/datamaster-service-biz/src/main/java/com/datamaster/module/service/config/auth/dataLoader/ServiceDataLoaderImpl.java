...
package com.datamaster.module.service.config.auth.dataLoader;
 ...
 */
@Component
public class ServiceDataLoaderImpl implements SaOAuth2DataLoader {
    ...
    public SaClientModel getClientModel(String clientId) {
        TaxonomyClientRespDTO client = clientApi.getClient(Convert.toLong(clientId));
