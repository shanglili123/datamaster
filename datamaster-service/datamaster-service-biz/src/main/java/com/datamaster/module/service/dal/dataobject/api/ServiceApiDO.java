package com.datamaster.module.service.dal.dataobject.api;
...
/**
 * API服务 DO 对象 Service_API
 *
 * @author lhs
 * @date 2025-02-12
 */
@Data
@TableName(value = "SVC_API")
// 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
// @KeySequence("Service_API_seq")
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class ServiceApiDO extends BaseEntity {
