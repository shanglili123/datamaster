...
//        }
     ...
     * @return
     */
    public void executeServiceForwarding(ServiceApiDO api, Map<String, Object> params, HttpServletResponse response) {
        ...
        if(StringUtils.equals("1",transmitType)){
            iAssetsApiOutService.executeServiceForwarding(response, JSONUtils.convertToLong(api.getApiId()),result);
        }else if(StringUtils.equals("1",transmitType)){
            iAssetsAssetGisOutService.executeServiceForwarding(response, JSONUtils.convertToLong(api.getApiId()),result);
        }else {
            return;
        }
    }
//
//    public static Map<String, Object> buildRequestObject(ServiceApiDO api,Map<String, Object> params) {
