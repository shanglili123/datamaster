...
public interface ServiceApiMapper extends BaseMapperX<ServiceApiDO> {
    ...
    default PageResult<ServiceApiDO> selectPage(ServiceApiPageReqVO reqVO) {
        ...
        lambdaWrapper.selectAll(ServiceApiDO.class)
                ...
                .leftJoin("TAX_CATEGORY t2 on t.CAT_CODE = t2.CODE AND t2.DEL_FLAG = '0' AND t2.CAT_TYPE = 'API'")
                ...
                .eq(reqVO.getSpaceId() != null, ServiceApiDO::getSpaceId, reqVO.getSpaceId())
                .eq(StringUtils.isNotBlank(reqVO.getSpaceCode()), ServiceApiDO::getSpaceCode, reqVO.getSpaceCode())
