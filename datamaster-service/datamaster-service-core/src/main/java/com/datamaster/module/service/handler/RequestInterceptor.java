...
package com.datamaster.module.service.handler;
...
import com.datamaster.common.enums.ParamType;
import com.datamaster.common.exception.ServiceException;
import com.datamaster.common.utils.IPUtil;
...
public class RequestInterceptor implements HandlerInterceptor {
     ...
     * @throws Exception
     */
    public void preHandle( HttpServletRequest request, HttpServletResponse response, ServiceApiDO api, Map<String, Object> params) {

//    public void preHandle(String username, HttpServletRequest request, HttpServletResponse response, ServiceApiDO api, Map<String, Object> params, DataApiApplyServiceFeign dataApiApplyService, SysUserServiceFeign sysUserService) {
...
//        }
//        ServiceApiLogDO dataApiApplyEntity = JSONObject.parseObject(JSONObject.toJSONString(res.getData()), DataApiApplyEntity.class);
...
//        }
     ...
     * @throws Exception
     */
    public void postHandle(HttpServletRequest request, HttpServletResponse response, ServiceApiDO api, Map<String, Object> params, Object value) throws Exception {
    }
}
