...
export function getDaDiscoveryTableList(query) {
  return request({
    url: '/ast/discoveryTable/getDaDiscoveryTableList',
    method: 'get',
    params: query
  })
}
...
export function commitOrRevokeDiscoveryInfo(data) {
  return request({
    url: '/ast/discoveryTable/commitOrRevokeDiscoveryInfo',
    method: 'post',
    data: data
  })
}
...
export function getDaDiscoveryColumnList(params) {
  return request({
    url: '/ast/discoveryColumn/getDaDiscoveryColumnList',
    method: 'get',
    params: params
  })
}
...
export function preview(data) {
  return request({
    url: '/ast/discoveryTable/preview',
    method: 'post',
    data: data
  })
}
