...
export function listRole(query) {
    return request({
        url: '/tax/projectUserRel/role/list',
        method: 'get',
        params: query
    });
}
...
export function getRole(roleId) {
    return request({
        url: '/tax/projectUserRel/role/' + roleId,
        method: 'get'
    });
}
...
export function dataScope(data) {
    return request({
        url: '/tax/projectUserRel/role/dataScope',
        method: 'put',
        data: data
    });
}
...
export function allocatedUserList(query) {
    return request({
        url: '/tax/projectUserRel/role/authUser/allocatedList',
        method: 'get',
        params: query
    });
}
...
export function unallocatedUserList(query) {
    return request({
        url: '/tax/projectUserRel/role/authUser/unallocatedList',
        method: 'get',
        params: query
    });
}
...
export function authUserCancel(data) {
    return request({
        url: '/tax/projectUserRel/role/authUser/cancel',
        method: 'put',
        data: data
    });
}
...
export function authUserCancelAll(data) {
    return request({
        url: '/tax/projectUserRel/role/authUser/cancelAll',
        method: 'put',
        params: data
    });
}
...
export function authUserSelectAll(data) {
    return request({
        url: '/tax/projectUserRel/role/authUser/selectAll',
        method: 'put',
        params: data
    });
}
...
export function deptTreeSelect(roleId) {
    return request({
        url: '/tax/projectUserRel/role/deptTree/' + roleId,
        method: 'get'
    });
}
