...
export function logDetailCat(query) {
  return request({
    url: '/ast/discoveryTaskLog/logDetailCat',
    method: 'get',
    params: query
  })
}
...
export function downloadLog(query) {
  return request({
    url: '/ast/discoveryTaskLog/downloadLog',
    method: 'get',
    params: query
  })
}
