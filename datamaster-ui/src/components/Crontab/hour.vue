    ...
    <a-form>
        ...
        <a-form-item>
            <a-radio-group v-model:value="radioValue">
                <a-radio :value="2">
                    周期从
                    <a-input-number v-model:value="cycle01" :min="0" :max="22" /> -
                    <a-input-number v-model:value="cycle02" :min="cycle01 + 1" :max="23" /> 时
                </a-radio>
            </a-radio-group>
        </a-form-item>
        ...
        <a-form-item>
            <a-radio-group v-model:value="radioValue">
                <a-radio :value="3">
                    从
                    <a-input-number v-model:value="average01" :min="0" :max="22" /> 时开始，每
                    <a-input-number v-model:value="average02" :min="1" :max="23 - average01" /> 小时执行一次
                </a-radio>
            </a-radio-group>
        </a-form-item>
            ...
            <a-radio-group v-model:value="radioValue">
                <a-radio :value="4">
                    ...
                    <a-select
                        ...
                        :multiple-limit="10"
                    >
                        <a-select-option v-for="item in 24" :key="item" :label="item - 1" :value="item - 1" />
                    </a-select>
                </a-radio>
            </a-radio-group>
        </a-form-item>
