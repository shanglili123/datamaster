    ...
    <a-form>
        ...
        <a-form-item>
            <a-radio-group v-model:value="radioValue">
                <a-radio :value="3">
                    周期从
                    <a-select allow-clear v-model:value="cycle01">
                        <a-select-option
                    ...
                    -
                    <a-select allow-clear v-model:value="cycle02">
                        <a-select-option
                            v-for="(item, index) of weekList"
                            :key="index"
                            :label="item.value"
        ...
        <a-form-item>
            <a-radio-group v-model:value="radioValue">
                <a-radio :value="4">
                    第
                    <a-input-number v-model:value="average01" :min="1" :max="4" /> 周的
                    <a-select allow-clear v-model:value="average02">
                        <a-select-option
        ...
        <a-form-item>
            <a-radio-group v-model:value="radioValue">
                <a-radio :value="5">
                    本月最后一个
                    <a-select allow-clear v-model:value="weekday">
                        <a-select-option
                            v-for="item in weekList"
                            :key="item.key"
                            :label="item.value"
