        ...
        <el-row :gutter="2">
          <el-col :span="8">
            <el-form-item label="字段注释" prop="columnComment">
              <el-input
                v-model="editForm.columnComment"
                placeholder="请输入字段注释"
              />
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="2">
          <el-col :span="8">
            <el-form-item label="字段精度" prop="columnPrecision">
              <el-input
                v-model="editForm.columnPrecision"
                placeholder="字段精度"
                disabled
              />
            </el-form-item>
