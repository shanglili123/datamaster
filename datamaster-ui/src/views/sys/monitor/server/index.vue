  ...
  <div class="app-container">
    <a-row :gutter="15">
      <a-col :span="12" class="card-box">
        <a-card>
          <template #title><ThunderboltOutlined style="width: 1em; height: 1em; vertical-align: middle;" /> <span style="vertical-align: middle;">CPU</span></template>
          <div class="monitor-table">
            <table cellspacing="0" style="width: 100%;">
              <thead>
                <tr>
                  <th ><div class="cell">属性</div></th>
                  <th ><div class="cell">值</div></th>
                </tr>
              </thead>
              <tbody>
                <tr>
      ...
      <a-col :span="12" class="card-box">
        <a-card>
          <template #title><FileTextOutlined style="width: 1em; height: 1em; vertical-align: middle;" /> <span style="vertical-align: middle;">内存</span></template>
          <div class="monitor-table">
            <table cellspacing="0" style="width: 100%;">
              <thead>
                <tr>
                  <th ><div class="cell">属性</div></th>
                  <th ><div class="cell">内存</div></th>
                  <th ><div class="cell">JVM</div></th>
                </tr>
              </thead>
              <tbody>
                <tr>
      ...
      <a-col :span="24" class="card-box">
        <a-card>
          <template #title><MonitorOutlined style="width: 1em; height: 1em; vertical-align: middle;" /> <span style="vertical-align: middle;">服务器信息</span></template>
          <div class="monitor-table">
            <table cellspacing="0" style="width: 100%;">
              <tbody>
                <tr>
      ...
      <a-col :span="24" class="card-box">
        <a-card>
          <template #title><CoffeeOutlined style="width: 1em; height: 1em; vertical-align: middle;" /> <span style="vertical-align: middle;">Java虚拟机信息</span></template>
          <div class="monitor-table">
            <table cellspacing="0" style="width: 100%;table-layout:fixed;">
              <tbody>
                ...
                <tr>
                  <td colspan="1" ><div class="cell">空间路径</div></td>
                  <td colspan="3" ><div class="cell" v-if="server.sys">{{ server.sys.userDir }}</div></td>
                </tr>
                <tr>
                  <td colspan="1" ><div class="cell">运行参数</div></td>
                  <td colspan="3" ><div class="cell" v-if="server.jvm">{{ server.jvm.inputArgs }}</div></td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <a-col :span="24" class="card-box bottom">
        <a-card>
          <template #title><MessageOutlined style="width: 1em; height: 1em; vertical-align: middle;" /> <span style="vertical-align: middle;">磁盘状态</span></template>
          <div class="monitor-table">
            <table cellspacing="0" style="width: 100%;">
              <thead>
                <tr>
...
import { ThunderboltOutlined, FileTextOutlined, MonitorOutlined, CoffeeOutlined, MessageOutlined } from '@ant-design/icons-vue'
