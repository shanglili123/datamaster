   ...
   <div class="app-container" ref="app-container">
      <div class="pagecont-top" v-show="showSearch">
         ...
         <div class="data-action-btns">
            ...
            <el-dropdown trigger="click" v-hasPermi="['system:config:export', 'system:config:remove']">
              <el-button type="info" plain>
                更多<i class="el-icon-arrow-down el-icon--right"></i>
              </el-button>
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item icon="Download" @click="handleExport" v-hasPermi="['system:config:export']">导出</el-dropdown-item>
                  <el-dropdown-item icon="Refresh" @click="handleRefreshCache" v-hasPermi="['system:config:remove']">刷新缓存</el-dropdown-item>
                </el-dropdown-menu>
              </template>
            </el-dropdown>
         </div>
