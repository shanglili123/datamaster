...
if ($PSCmdlet.ShouldProcess(($containers -join ", "), "Start WSL Docker development services")) {
    Write-Host "Starting WSL Docker development services..."
    Invoke-WslDocker -DockerArguments (@("start") + $containers)
}
