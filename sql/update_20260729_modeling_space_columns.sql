...
ALTER TABLE IF EXISTS mdl_business_category ADD COLUMN IF NOT EXISTS space_id bigint;
ALTER TABLE IF EXISTS mdl_business_category ADD COLUMN IF NOT EXISTS space_code varchar(64);
ALTER TABLE IF EXISTS mdl_data_domain ADD COLUMN IF NOT EXISTS space_id bigint;
ALTER TABLE IF EXISTS mdl_data_domain ADD COLUMN IF NOT EXISTS space_code varchar(64);
ALTER TABLE IF EXISTS mdl_data_layer ADD COLUMN IF NOT EXISTS space_id bigint;
ALTER TABLE IF EXISTS mdl_data_layer ADD COLUMN IF NOT EXISTS space_code varchar(64);
ALTER TABLE IF EXISTS mdl_data_layer_specification ADD COLUMN IF NOT EXISTS space_id bigint;
ALTER TABLE IF EXISTS mdl_data_layer_specification ADD COLUMN IF NOT EXISTS space_code varchar(64);
ALTER TABLE IF EXISTS mdl_theme_domain ADD COLUMN IF NOT EXISTS space_id bigint;
ALTER TABLE IF EXISTS mdl_theme_domain ADD COLUMN IF NOT EXISTS space_code varchar(64);
